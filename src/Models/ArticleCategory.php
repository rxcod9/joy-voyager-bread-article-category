...
namespace Joy\VoyagerBreadArticleCategory\Models;
...
use Joy\VoyagerBreadArticleCategory\Database\Factories\ArticleCategoryFactory;
...
class ArticleCategory extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('ArticleCategory'));
    }
